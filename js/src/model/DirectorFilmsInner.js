...
class DirectorFilmsInner {
    /**
     * Constructs a new <code>DirectorFilmsInner</code>.
    ...
    /**
     * Constructs a <code>DirectorFilmsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectorFilmsInner} obj Optional instance to populate.
     * @return {module:model/DirectorFilmsInner} The populated <code>DirectorFilmsInner</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DirectorFilmsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectorFilmsInner</code>.
     */
